...
flt{iFlt}.param.fltNum = 14;
flt{iFlt}.param.config = '1';
flt{iFlt}.param.apVers = '40';

iFlt = iFlt + 1;
flt{iFlt}.param.vehName = 'Geri';
flt{iFlt}.param.apType = 'Goldy1';
flt{iFlt}.param.fltNum = 15;
flt{iFlt}.param.config = '1';
flt{iFlt}.param.apVers = '40';
...
param{iSeg}.indxSeg = flt{iFlt}.seg.turnaccel{1}.indx;

iSeg = iSeg+1; iFlt = 3;
param{iSeg} = flt{iFlt}.param;
param{iSeg}.indxFlt = iFlt;
param{iSeg}.indxSeg = flt{iFlt}.seg.turnaccel{2}.indx;

iSeg = iSeg+1; iFlt = 3;
param{iSeg} = flt{iFlt}.param;
param{iSeg}.indxFlt = iFlt;
param{iSeg}.indxSeg = flt{iFlt}.seg.turnaccel{3}.indx;
...
%     param{iSeg}.v_PA_P_mps.errorType = 'Inverse2Bias+';
%     param{iSeg}.v_PA_P_mps.bias = 30;
%     param{iSeg}.v_PA_P_mps.K = -400;
%     param{iSeg}.v_PA_P_mps.errorType = 'Quad+';
%     param{iSeg}.v_PA_P_mps.Quad = 1.0;
%     param{iSeg}.v_PA_P_mps.K = 1.3;
%     param{iSeg}.v_PA_P_mps.bias = -3.5;
...
% indxOptStatic = indxOptStatic + 1;
% optParam.static{indxOptStatic}.field = 'v_PA_P_mps.Quad';
% optParam.static{indxOptStatic}.len = 1;
...
for iSeg = 1:numSeg
    PlotCell({seg{iSeg}.time_s}, ...
        ...
        {seg{iSeg}.alpha_BA_deg, seg{iSeg}.alphaCal_BA_deg}, ...
        {seg{iSeg}.beta_BA_deg, seg{iSeg}.alphaCal_BA_deg}}, ...
        optPlotCell);
    hold on;
end
