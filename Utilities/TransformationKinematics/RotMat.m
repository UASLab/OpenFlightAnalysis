...
%Version History: Version 1.6
% 09/20/2016  C. Regan     Initial Release (v1.0)
% 09/23/2016  C. Regan     Switched to using input parsing (v1.1)
% 09/27/2016  C. Regan     Fixed ordering of outputs (v1.2)
% 09/28/2016  C. Regan     Added vector inputs rather than cell array inputs (v1.3)
% 10/06/2016  C. Regan     Fixed Angle Sequencing (v1.4)
% 10/17/2016  C. Regan     Changed to simple and faster input parsing (v1.5)
% 10/17/2016  C. Regan     Added hard-coded '321' case for speed (v1.6)
%
