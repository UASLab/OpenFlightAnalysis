...
% Modify an excitation signal.
%
%Usage:  [signals, time_s] = ModifyExcitation(signals, time_s, gains, numRepeat, seperateSW, timeLead_s, timeTrail_s);
%
%Inputs:
...
% 06/12/2006  C. Regan     Initial Release (v1.0)
...
if timeLead_s > 0
    lenLead = min(find(time_s >= timeLead_s)) - 1;
