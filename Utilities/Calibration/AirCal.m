function [vEst_BA_B_mps, vEst_BA_L_mps] = AirCal(vMeasMag_PA_mps, s_BL_rad, param)
% Compute the Pitot Respose with a given sensor error model.
%
% %Inputs:
% vMeasMag_PA_mps - Magnitude of the Measured Velocity of the Probe wrt Atm [P/A] (m/s2)
...
% param           - Structure
%  (v_PA_P_mps)   - Pitot Probe Error Model Parameters
