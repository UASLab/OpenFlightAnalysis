function [vEquiv_kts] = Vcal2Ve(vCal_kts, alt_ft)
% Convert calibrated airspeed to equivalent airspeed at a given altitude.
%
%Usage:  [vEquiv_kts] = Vcal2Ve(vCal_kts, alt_ft);
%
%Inputs:
...
%
%Outputs:
% vEquiv_kts - equivalent airspeed (knots)
%
%Notes:
% 
%
...
% Equivalent airspeed
vEquiv_fps = sqrt((2/(gamma-1))*(gamma*pres_lbpft2/densSL_spft3)*(((presT_lbpft2-pres_lbpft2)/pres_lbpft2 + 1)^((gamma-1)/gamma) - 1));

% Convert to knots
vEquiv_kts = vEquiv_fps / kt2fps;
